...
def growth_signal(history: list[float], window: int) -> float:
    """
    Median period-over-period growth rate over the last `window` observations - used for both price and rent growth for households.
    """
...
def inst_rent_growth_signal(state_history: list[dict], window: int) -> float:
    """
